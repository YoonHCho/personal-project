...
app.put(
  "https://personal-project-production-cc4d.up.railway.app/total/:num",
  (req, res) => {
...
app.put(
  "https://personal-project-production-cc4d.up.railway.app/today/:num",
  (req, res) => {
...
app.put(
  "https://personal-project-production-cc4d.up.railway.app/today/date/:num",
  (req, res) => {
...
app.post(
  "https://personal-project-production-cc4d.up.railway.app/register",
  (req, res) => {
...
app.post(
  "https://personal-project-production-cc4d.up.railway.app/sign-in",
  (req, res) => {
...
app.delete(
  "https://personal-project-production-cc4d.up.railway.app/messages/delete/:commentid",
  (req, res) => {
...
app.put(
  "https://personal-project-production-cc4d.up.railway.app/messages/edit/:commentid",
  (req, res) => {
    const commentid = Number(req.params.commentid);
